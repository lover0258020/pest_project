...
<html>
  ...
  <body>
    <div id="map"></div>
    <button onclick="" class="button_mission" style="width: 150px; height:70px; position:absolute; top:350px; left:110px;" ><span style="font-size:18px;">手動飛行</span></button>

<button onclick="" class="button_mission" style="width: 150px; height:70px; position:absolute; top:470px; left:110px;" ><span style="font-size:18px;">自動飛行</span></button>
  </body>
</html>
